# Kidoz AdMob Adapter SDK

Kidoz iOS AppLovin MAX Adapter SDK for Swift Package Manager.
...
```swift
dependencies: [
    .package(url: "https://github.com/Kidoz-SDK/admob-adapter-swift-package.git", "2.0.0"..<"2.1.0")
]
```
